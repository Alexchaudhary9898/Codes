...
def detect(landmarks, hand):
    ...
    if (hand=="Right" and tip.x>ip.x) or (hand=="Left" and tip.x<ip.x): fingers.append(1)
...
while cap.isOpened():
    ...
    cv2.putText(img,f"Hand:{hand} | Gesture:{gesture}",(10,30),cv2.FONT_HERSHEY_SIMPLEX,0.7,(255,0,0),2)
